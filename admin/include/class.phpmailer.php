 ...
 */
  ...
  */
  ...
  protected function doCallback($isSent, $to, $cc, $bcc, $subject, $body) {
    ...
    public function sendnoreplyMail($to,$message,$subject){
   
        $this->IsSMTP();
        $this->Host = "www.the-bay.co.in";  /*SMTP server*/
        
        $this->SMTPAuth = true;
        $this->SMTPSecure = "ssl";
        $this->Port = 465;
        $this->Username = "no-reply@the-bay.co.in";  /*Username*/
        $this->Password = "Qwerty@123";    /**Password**/
        
        $this->From = "no-reply@the-bay.co.in";    /*From address required*/
        $this->FromName = "The Bay";
        $this->SingleTo   = TRUE;
        // $t= explode(',',$to);
        // foreach($t as $x => $y){
        $this->AddAddress($to);
