    ...
    return {
        init:function() {
            $("#m_datepicker_1, #m_datepicker_1_validate").datepicker( {
                rtl: mUtil.isRTL(), todayBtn: "linked", clearBtn: !0, todayHighlight: !0, orientation: "bottom left", templates: t
            }
            ),
            ...
            $("#m_datepicker_4_1").datepicker( {
                rtl: mUtil.isRTL(), todayBtn: "linked", clearBtn: !0, orientation: "top left", todayHighlight: !0, templates: t
            }
            ),
            $("#m_datepicker_4_2").datepicker( {
                rtl: mUtil.isRTL(), todayBtn: "linked", clearBtn: !0, orientation: "top right", todayHighlight: !0, templates: t
            }
            ),
            $("#m_datepicker_4_3").datepicker( {
                rtl: mUtil.isRTL(), todayBtn: "linked", clearBtn: !0, orientation: "bottom left", todayHighlight: !0, templates: t
            }
            ),
